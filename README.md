...
2. **DPP Blocks View** — lets the user select one DPP block at a time, so clicking Identification, Origin, Composition, Compliance, etc. shows only that block.
